...
func init() {
	...
	RegisterLazyProviderModule("openai-codex", func() ProviderModule {
		return ProviderModule{
			...
			NormalizeOptions: normalizeOpenAICodexOptions,
			Models: map[string]Model{
				"gpt-5.1": {
					ID:            "gpt-5.1",
					Name:          "GPT-5.1",
	...
	RegisterLazyProviderModule("kimi-coding", func() ProviderModule {
		return ProviderModule{
			...
			NormalizeOptions: normalizeKimiCodingOptions,
			Models: map[string]Model{
				"k2p5": {
					ID:            "k2p5",
					Name:          "Kimi K2.5",
	...
	RegisterLazyProviderModule("openrouter", func() ProviderModule {
		return ProviderModule{
			Provider: "openrouter",
			Models: map[string]Model{
